...
//   const { signOut } = useAuth()
  ...
  return (
    <div>
      ...
      <div className='fixed overflow-y-scroll overscroll-y-none inset-0 z-40 flex flex-row-reverse'>
        <div className='w-3/4 flex flex-row-reverse'>
          <div className='relative flex w-full max-w-sm flex-col overflow-y-auto bg-white pb-12 shadow-xl'>
            <div className='flex self-end px-4 pb-2 pt-5'>
              <button
                type='button'
            ...
            <div className='space-y-6 border-t border-gray-200 px-4 py-6'>
              ...
              {user.user ? null : (
                <span
                  className='w-6 h-px bg-gray-200'
                  aria-hidden='true'
                />
              )}
